...
<body>
  ...
  <div class="bg-white shadow-lg rounded-lg overflow-hidden max-w-4x w-full md:w-[60vw] lg:w-2/5 h-auto">
    <div class="right w-full p-8 lg:p-4 md:p-16">
      ...
      <!-- FORM BEGINS -->
      <!-- <form method="post" id="formForgetPassword" class="space-y-6"> -->
      <form method="post" action="../includes/login.inc.php" class="space-y-6">
        ...
        <button type="submit" id="forgetPassword" name="forgetPassword" class="w-full py-3 bg-[#556B2F] text-white font-semibold rounded-md hover:bg-opacity-80 transition">Login</button>
