        ...
        <section class="lg:ml-[15vw] pt-10 px-5 lg:h-[91.5vh]">
            ...
            <div class="skill bg-white py-5 rounded-lg">
                ...
                <div class="skill-container">
                    <!-- <form action="includes/skill.inc.php" method="post" id="skillForm" class="px-5 rounded-md grid gap-3 text-sm lg:text-lg hiden"> -->
                    <form id="skillForm" class="px-5 rounded-md grid gap-3 text-sm lg:text-lg hiden">
